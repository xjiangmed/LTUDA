...
class VisionTransformer(nn.Module):
    ...
    def prototype_learning(self, _c, out_seg, gt_seg, masks, labeled=True): #update prototype
        ...
        # pred_seg = get_prediction(out_seg) #(0,1,2,3,4) bug!
        mask = (gt_seg == pred_seg.view(-1)) #[262144,1]
        ...
        for k in range(self.num_classes):
            init_q = masks[..., k] #[262144,1]
            init_q = init_q[gt_seg == k, ...] #[107139,1]
            
            if init_q.shape[0] == 0:
                continue

            q, indexs = distributed_sinkhorn(init_q)#[107139,1]#[107139]
