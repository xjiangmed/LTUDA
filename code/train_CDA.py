...
def main():
    ...
    for epoch in range(args.num_epochs): 
        ...
        for iter, batch in train_phar:
            ...
            loss_w =  loss_pBCE.forward(outputs[:bs], partial_labels_4ch_w)
            loss_s1 = loss_pBCE.forward(outputs[bs:bs*2], pseudo_labels_s1_4ch)
            loss_s2 = loss_pBCE.forward(outputs[bs*2:bs*3], pseudo_labels_s2_4ch)
